...
import { getCachedNode, readField, type FeatureDef, type FeatureObject } from "../feature";
...
export const innerPole: FeatureDef<InnerPoleConfig> = {
  type: "innerPole",
  ...
  Inspector: ({ ctx }) => {
    const getPercent = (obj: FeatureObject) => Math.round(readField<number>(obj, "height", 0) * 100);
    return (
      <>
